...
Complete these for your repository. They are the highest-value context an agent can have, and
this section is the staging point where a team adapts the foundation to its own stack.

- Toolchain: <!-- language(s), runtime and version, package manager -->
- Build: <!-- command to build -->
- Test: <!-- command for the full suite, and how to run one file or one test -->
- Lint and format: <!-- commands, and whether they must pass before a change is submitted -->
- Dependencies and licensing: <!-- how dependencies are added and pinned; allowed licenses -->
- Run locally: <!-- how to start the app or service -->
- Architecture: <!-- entry points, main modules, where things live -->
- Conventions: <!-- naming, error handling, logging, and framework idioms specific to here -->
- Boundaries: <!-- what must never change without sign-off; secrets; production paths -->
- Definition of done: <!-- which checks gate a change in this repository -->
